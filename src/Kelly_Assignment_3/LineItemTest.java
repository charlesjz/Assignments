...
class LineItemTest {
	...
	public void testLineItemPizza() throws Exception {
		...
		System.out.println(line1.getPizza());
		System.out.println(line1.getNumber());
		System.out.println(line1.getCost());
...
//		LineItem same1 = new LineItem(1, new Pizza("small", "single", "none", "none", "single")); // total cost $8.50
		LineItem same1 = new LineItem(1, new Pizza("small", "single", "none", "single", "none")); // total cost $8.50
...
//		LineItem higher1 = new LineItem(2, new Pizza("small", "double", "none", "none", "single"));
		LineItem higher1 = new LineItem(2, new Pizza("small", "double", "none", "single", "none"));
//		LineItem higher2 = new LineItem(2, new Pizza("medium", "double", "none", "none", "single"));
		LineItem higher2 = new LineItem(2, new Pizza("medium", "double", "none", "single", "none"));
//		LineItem highest = new LineItem(10, new Pizza("small", "double", "none", "none", "single"));
		LineItem highest = new LineItem(10, new Pizza("small", "double", "none", "single", "none"));
